...
public partial class OptionSettingWindow
{
    ...
    public OptionSettingWindow()
    {
        ...
        this.WhenActivated(disposables =>
        {
            ...
            this.Bind(ViewModel, vm => vm.AutoRealPingTest, v => v.togAutoRealPingTest.IsChecked).DisposeWith(disposables);
            this.Bind(ViewModel, vm => vm.AutoRealPingTestInterval, v => v.txtAutoRealPingTestInterval.Text).DisposeWith(disposables);
